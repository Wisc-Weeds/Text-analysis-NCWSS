...
```{r}
Data <- bind_rows(words02, words03, words04, words05, words06, words08, words09, words10, words11, words12, words13, words14, words15, words16, words17, words18)
...
```{r}
ggplot(data, aes(x=year, y=freq, color=word)) + geom_line() + geom_point() +
  theme_bw() + ggsave("weeds.png")
```
