...
```{r}
pdf_01 <- pdf_text("docs/nc2001.pdf") %>% 
  strsplit(split = "\n")
...
titledm_01$names <- gsub("marestail" , "horseweed" , titledm_01$names)
...
titledm_02$names <- gsub("marestail" , "horseweed" , titledm_02$names)
...
titledm_03$names <- gsub("marestail" , "horseweed" , titledm_03$names)
...
titledm_04$names <- gsub("marestail" , "horseweed" , titledm_04$names)
...
titledm_05$names <- gsub("marestail" , "horseweed" , titledm_05$names)
...
titledm_06$names <- gsub("marestail" , "horseweed" , titledm_06$names)
...
titledm_07$names <- gsub("marestail" , "horseweed" , titledm_07$names)
...
titledm_08$names <- gsub("marestail" , "horseweed" , titledm_08$names)
...
titledm_09$names <- gsub("marestail" , "horseweed" , titledm_09$names)
...
titledm_10$names <- gsub("marestail" , "horseweed" , titledm_10$names)
...
titledm_11$names <- gsub("marestail" , "horseweed" , titledm_11$names)
...
titledm_12$names <- gsub("marestail" , "horseweed" , titledm_12$names)
...
titledm_13$names <- gsub("marestail" , "horseweed" , titledm_13$names)
...
titledm_14$names <- gsub("marestail" , "horseweed" , titledm_14$names)
...
titledm_15$names <- gsub("marestail" , "horseweed" , titledm_15$names)
...
titledm_16$names <- gsub("marestail" , "horseweed" , titledm_16$names)
...
titledm_17$names <- gsub("marestail" , "horseweed" , titledm_17$names)
...
titledm_18$names <- gsub("marestail" , "horseweed" , titledm_18$names)
...
titledm_19$names <- gsub("marestail" , "horseweed" , titledm_19$names)
...
```{r}
freq_by_rank %>% 
  filter(year == "2019" & word == "horseweed")
```
...
ggplot(freq_by_rank_1, aes(x = year, y = rank, group = word)) +
  ...
  scale_color_manual(values = c("#FFFF60", "#8EF78E", 
                                "#D0FFFF", "#FF78FF", 
                                "#4281A4", "#48A9A6", "#D4B483", 
                                "#E4DFDA", "#FE5F55",
                                "#C1666B", "#39393A")) +
...
#scale_y_reverse(breaks = 1:nrow(NY_kids)) +
  labs(title = "NCWSS Meeting text analysis of title and abstracts from 2001 through 2019",
       subtitle = "Rank of the top 100 words of each NCWSS annual meeting proceeding with selected highlighted herbicides", y= "Rank",
